...
export const translations: Record<Locale, Translations> = {
  th: {
    ...
    result: {
      title: 'เสร็จสิ้น!',
      subtitle: 'นี่คือตัวตนการทำงานของคุณ',
    ...
    admin: {
      ...
      tip3: 'พิจารณาใช้โปรแกรมจัดการรหัสผ่าน',
      tip4: 'เปลี่ยนรหัสผ่านอย่างสม่ำเสมอ',
    ...
    styles: {
      1: {
        ...
        strengths: 'ความน่าเชื่อถือ ความสม่ำเสมอ การจัดการความเสี่ยง ความละเอียด และการสร้างกระบวนการที่เสถียร',
      ...
      2: {
        ...
        strengths: 'การสร้างทีม การสื่อสาร ความเห็นใจผู้อื่น การร่วมมือ และการสร้างวัฒนธรรมการทำงานที่เป็นบวก',
      ...
      3: {
        name: 'ผู้ทำงานเก่ง',
        definition: 'คุณถูกขับเคลื่อนโดยความสำเร็จ การยอมรับ และการแข่งขัน คุณชอบตั้งเป้าหมายท้าทายและได้รับการยอมรับสำหรับผลงานของคุณ',
        strengths: 'การบรรลุเป้าหมาย แรงขับเคลื่อนแบบแข่งขัน ความเปี่ยมด้วยผลงาน และสร้างแรงบันดาลใจให้ผู้อื่นด้วยผลลัพธ์',
        hrAdvice: 'ดำเนินการรางวัลตามผลงาน โปรแกรมการยอมรับในสาธารณะ KPI ที่ชัดเจน และโอกาสการเลื่อนขั้น เฉลิมฉลองชัยชนะอย่างเด่นชัด'
      },
      4: {
        name: 'ผู้นำ',
        definition: 'คุณมีความโนมมาต่อการรับผิดชอบและการตัดสินใจเชิงกลยุทธ์ คุณเพลิดเพลินกับความรับผิดชอบ อิทธิพล และการนำทีมสู่ความสำเร็จ',
        strengths: 'การคิดเชิงกลยุทธ์ การตัดสินใจ การตั้งวิสัยทัศน์ การนำทิศทางทีม และความรับผิดชอบ',
      ...
      5: {
        ...
        definition: 'ค่าตอบแทนและผลประโยชน์ที่จับต้องได้เป็นแรงจูงใจหลักของคุณ คุณแสวงหาค่าจ้างที่เป็นธรรม โบนัส และรางวัลที่เป็นรูปธรรมสำหรับผลงานของคุณ',
        strengths: 'การวางแผนการเงิน การมุ่งเน้นผลตอบแทนต่อการลงทุน การตัดสินใจตามคุณค่า และทักษะการเจรจา',
        hrAdvice: 'เสนอค่าตอบแทนที่แข่งขันได้ โครงสร้างโบนัสที่ชัดเจน มาตรเงินเดือนที่โปร่งใส และแรงจูงใจทางการเงินที่เกี่ยวข้องกับผลงาน'
      },
      6: {
        name: 'ผู้เชี่ยวชาญ',
        ...
        strengths: 'ความรู้ลึกซึ้ง การแก้ปัญหา ความเปี่ยมด้วยทักษะทางเทคนิค การเรียนรู้อย่างต่อเนื่อง และนวัตกรรมในพื้นที่เฉพาะทาง',
        hrAdvice: 'สนับสนุนการศึกษาอย่างต่อเนื่อง การรับรองคุณวุฒิ โปรเจ็กต์เฉพาะทาง การยอมรับความเชี่ยวชาญ และโอกาสในการเป็นที่ปรึกษาในสาขาของพวกเขา'
      },
      7: {
      ...
      8: {
        ...
        hrAdvice: 'เสนอการจัดรูปแบบการทำงานที่ยืดหยุ่น ตัวเลือกทำงานจากระยะไกล การประเมินผลตามผลลัพธ์ และหลีกเลี่ยงไมโครแมเนจเมนต์ ไว้ใจในกระบวนการของพวกเขา'
      },
      9: {
        name: 'ผู้บันเทิง',
